...
(function () {
   ...
   describe('AuthenticationController', function () {
      ...
      // _$httpBackend_). This allows us to inject a service but then attach it
      // to a variable with the same name as the service.
      ...
      it('$scope.signin() should login with a correct user and password',
         function () {
      ...
      it('$scope.signup() should fail to register with duplicate Username',
         function () {
            // Test expected POST request
